...
passpage = []
for i in range(10):
    base_url = 'https://shop.adidas.co.kr/PF020201.action?command=LIST&ALL=ALL&S_CTGR_CD=01001001&CONR_CD=10&S_ORDER_BY=1&S_PAGECNT=100&PAGE_CUR=' + str(i + 1)
...
for url in passpage:
    ...
    for q,w,e in zip(model_list,shosname_list,kate_list):
        allshos_list.append(q,w,e)

print(allshos_list)
# with open('AdidasMen.csv', 'wt', encoding='utf-8') as f:
#     writer = csv.writer(f, delimiter=',')
#     writer.writerows(model_list)
#     writer.writerows(shosname_list)
#     writer.writerows(kate_list)
#
