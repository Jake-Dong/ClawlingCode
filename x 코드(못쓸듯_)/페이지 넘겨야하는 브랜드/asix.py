...
# base_url = 'https://www.asics.com/kr/ko-kr/mens-running-shoes/c/ka10201000/?start=1'
# aaa = get_link(base_url)
#
# print(aaa)
allsearchlist = []
for i in range(6):
    base_url = 'https://www.asics.com/kr/ko-kr/mens-running-shoes/c/ka10201000/?start='+ str(i)
    aaa = get_link(base_url)
    allsearchlist.append(aaa)

f = open('asix.csv', 'w', encoding='utf-8', newline='')
